...
import firstshape_light from "@/public/light_story.png";
import firstshape_dark from "@/public/dark_story.png";
...
const Hero47 = ({
   heading = "Три месяца бесплатно",
  subheading = "",
  description = `Станьте нашими партнёрами и зарабатывайте на рекомендациях!

• Расскажите о нас друзьям в сторис во всех соцсетях
• Отправьте в поддержку VPNand скриншоты ваших сторис
• Получите бесплатный ключ на 3 месяца`,
            ...
            <div className="relative border-[5px] border-gray-800 bg-[#252732] rounded-[2.6rem] shadow-2xl w-[288px] h-[593px]">
              ...
              <div className="overflow-hidden rounded-[2.5rem] w-full h-full flex items-center justify-center">
                ...
                <Image
                  ...
                  className="w-[300px] h-[580px] object-cover rounded-[2rem] block dark:hidden"
                  priority
                />
                {/* Тёмная тема */}
                <Image
